...
//        {
//            public IFormFile ScanFile { get; set; } = default!;
...
//           [FromForm] UploadScanDto uploadScanDto)
//        {
//            var patientId = User.FindFirst(ClaimTypes.NameIdentifier)?.Value;
//            if (string.IsNullOrEmpty(patientId))
//                return Unauthorized("Patient identity not found.");

//            var result = await _mediator.Send(new UploadPatientScanCommand(patientId,uploadScanDto.DoctorId,uploadScanDto.ModelType,uploadScanDto.ScanFile));
